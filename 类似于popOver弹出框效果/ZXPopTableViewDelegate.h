...
@interface ZXPopTableViewDelegate : NSObject<UITableViewDelegate>

typedef void(^TableViewDidSelectRowAtIndexPath)(NSInteger indexRow); /** 点击cell事件回调 */
